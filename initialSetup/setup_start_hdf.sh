...
APP="hdf"
URL="https://downloads-hortonworks.akamaized.net/sandbox-hdf-3.1.1/HDF_3.1.1_deploy-scripts_180624d542a25.zip"
INSTFILE=${URL##*/}
...
bash $SETUPFILE
if [ $? -eq 0 ]; then
  echo -e "${GREEN}hdp docker successfully started! Please navigate to Sandbox Welcome Page http://sandbox-hdf.hortonworks.com:1080/${NC}"
else
